...
| WP-22 | Date/Time/Duration vollständig **+ temporale Built-ins** | WP-05, WP-21 | Zeitzonen, `@`-Literale, Dauer-Arithmetik, Vergleiche, `is`-Gleichheit **plus** die temporalen Built-ins aus der DMN-1.5-Tabelle (`now`, `today`, `date and time`, `time`, `duration`, `years and months duration`, `day of week`, `day of year`, `week of year`, `month of year`). Gegen FEEL-Spezifikationsbeispiele getestet. |
