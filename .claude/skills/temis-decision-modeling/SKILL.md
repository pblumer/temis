...
| `list_types` / `save_type` / `delete_type` | eigene Typen (Item-Definitionen) lesen, anlegen/ändern (einfach oder strukturiert via `components`), entfernen — jede Änderung liefert eine neue `modelId` |
